...
function estimateSurfaceTempAtPull(methodId, pullTempF) {
  ...
  const surfaceExcessF = {
    ...
    'sear-and-bake':  32,   // Sear creates steep surface gradient; 350°F oven deepens it but
                            // less aggressively than higher-heat ovens. Net: deeper stored heat
                            // than oven-moderate alone, but less surface-intense than pan-sear.
                            // Expected 8–12°F rise for 1–1.5" cuts.
  };
